...
#bg1_icon=ImageTk.PhotoImage(file=".jpg")
...
btn_log=tk.Button(Login_frame,text="Login",command=login,width=15,font=("Times new roman", 14, "bold"),bg="blue",fg="white")
btn_log.grid(row=3,column=1,pady=10)
btn_reg=tk.Button(Login_frame,text="Create Account",command=registration,width=15,font=("Times new roman", 14, "bold"),bg="brown",fg="white")
...
button1 = tk.Button(frame_alpr, text="Login", command=login, width=14, height=1,font=('times', 20, ' bold '), bg="Black", fg="white")
button1.place(x=150, y=110)

button2 = tk.Button(frame_alpr, text="Register",command=registration,width=14, height=1,font=('times', 20, ' bold '), bg="black", fg="white")
