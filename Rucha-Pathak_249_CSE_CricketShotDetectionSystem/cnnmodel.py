def main():
    ...
    basepath = r"C:\Users\soura\Downloads\finalyr project\Code Cricket shot\Code Cricket shot"
    ...
    #Saving the model
    #import h5py
    classifier.save(basepath + '/shot_model.h5')
    ...
    plt.title('model loss  wadsadsadawdasdwea')
    plt.ylabel('loss')
    plt.xlabel('epoch')
    plt.legend(['train', 'test'], loc='upper left')
